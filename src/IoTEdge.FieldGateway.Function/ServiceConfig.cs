...
namespace IoTEdge.FieldGateway.Function
{
    ...
    public class ServiceConfig
    {
        ...
        /// </summary>
        [JsonProperty("rtuMapStorageContainerName")]
        public string RtuMapStorageContainerName { get; set; }
        ...
        /// </summary>
        [JsonProperty("lussStorageTableName")]
        public string LussStorageTableName { get; set; }
    }
}
